...
class Result
{
    ...
    public function setStatus($status)
    {
        ...
        if (!in_array($status, array(self::STATUS_INFO, self::STATUS_OK, self::STATUS_ERROR, self::STATUS_WARNING))) {
            throw new LogicException(
                'Wrong status was given. Use constants: Result::INFO, Result::OK, Result::ERROR, Result::WARNING'
            );
        }
